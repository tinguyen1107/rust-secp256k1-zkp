...
for f in sorted(solutions.keys()):
    ...
    first = False
    print()
    print(f"static const rustsecp256k1zkp_v0_8_1_ge rustsecp256k1zkp_v0_8_1_ge_const_g = SECP256K1_G_ORDER_{f};")
    output_b(b)
    print()
print("#  else")
...
print("#else")
print()
print("static const rustsecp256k1zkp_v0_8_1_ge rustsecp256k1zkp_v0_8_1_ge_const_g = SECP256K1_G;")
output_b(7)
print()
print("#endif")
