""" Generates the constants used in rustsecp256k1zkp_v0_8_1_scalar_split_lambda.

See the comments for rustsecp256k1zkp_v0_8_1_scalar_split_lambda in src/scalar_impl.h for detailed explanations.
"""
...
def find_split_constants_gauss():
    """Find constants for rustsecp256k1zkp_v0_8_1_scalar_split_lamdba using gauss reduction."""
    (v11, v12), (v21, v22) = gauss_reduction([0, N], [1, int(LAMBDA)])

    # We use related vectors in rustsecp256k1zkp_v0_8_1_scalar_split_lambda.
    A1, B1 = -v21, -v11
    A2, B2 = v22, -v21
...
def find_split_constants_explicit_tof():
    """Find constants for rustsecp256k1zkp_v0_8_1_scalar_split_lamdba using the trace of Frobenius.
    ...
    # We use a negated b values in rustsecp256k1zkp_v0_8_1_scalar_split_lambda.
    B1, B2 = -B1, -B2
...
def scalar_lambda_split(k):
    """Equivalent to rustsecp256k1zkp_v0_8_1_scalar_lambda_split()."""
    c1 = rnddiv2((k * G1) >> 383)
    c2 = rnddiv2((k * G2) >> 383)
    c1 = (c1 * -B1) % N
    c2 = (c2 * -B2) % N
