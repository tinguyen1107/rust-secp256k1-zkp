 ...
 *  comparison, use rustsecp256k1zkp_v0_8_1_generator_serialize and rustsecp256k1zkp_v0_8_1_generator_parse.
 */
typedef struct {
    unsigned char data[64];
} rustsecp256k1zkp_v0_8_1_generator;

/**
 * Static constant generator 'h' maintained for historical reasons.
 */
SECP256K1_API const rustsecp256k1zkp_v0_8_1_generator *rustsecp256k1zkp_v0_8_1_generator_h;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_generator_parse(
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_generator_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *output,
    const rustsecp256k1zkp_v0_8_1_generator *gen
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_generator_generate(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_generator *gen,
 ...
 *  Args: ctx:     a secp256k1 context object (not rustsecp256k1zkp_v0_8_1_context_static)
 *  Out:  gen:     a generator object
 *  In:   seed32:  a 32-byte seed
 *        blind32: a 32-byte secret value to blind the generator with.
 *
 *  The result is equivalent to first calling rustsecp256k1zkp_v0_8_1_generator_generate,
 *  converting the result to a public key, calling rustsecp256k1zkp_v0_8_1_ec_pubkey_tweak_add,
 *  and then converting back to generator form.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_generator_generate_blinded(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_generator *gen,
    const unsigned char *seed32,
 ...
 *  however guaranteed to be 64 bytes in size, and can be safely copied/moved.
 *  If you need to convert to a format suitable for storage, transmission, or
 *  comparison, use rustsecp256k1zkp_v0_8_1_pedersen_commitment_serialize and
 *  rustsecp256k1zkp_v0_8_1_pedersen_commitment_parse.
 */
typedef struct {
    unsigned char data[64];
} rustsecp256k1zkp_v0_8_1_pedersen_commitment;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_pedersen_commitment_parse(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *  Args:   ctx:        a secp256k1 context object.
 *  Out:    output:     a pointer to a 33-byte byte array
 *  In:     commit:     a pointer to a rustsecp256k1zkp_v0_8_1_pedersen_commitment containing an
 *                      initialized commitment
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_pedersen_commitment_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *output,
    const rustsecp256k1zkp_v0_8_1_pedersen_commitment *commit
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_pedersen_commit(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  rustsecp256k1zkp_v0_8_1_pedersen_commitment *commit,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_pedersen_blind_sum(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_pedersen_verify_tally(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  const rustsecp256k1zkp_v0_8_1_pedersen_commitment * const *commits,
  size_t pcnt,
  const rustsecp256k1zkp_v0_8_1_pedersen_commitment * const *ncommits,
  size_t ncnt
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_pedersen_blind_generator_blind_sum(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
