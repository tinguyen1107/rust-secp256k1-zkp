 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_rangeproof_verify(
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_rangeproof_rewind(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_rangeproof_sign(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  unsigned char *proof,
  size_t *plen,
  uint64_t min_value,
 ...
 *        max_value: pointer to an unsigned int64 which will be updated with the maximum value that commit could have. (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_rangeproof_info(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  int *exp,
  int *mantissa,
  uint64_t *min_value,
 ...
 * the `exp` parameter to `rustsecp256k1zkp_v0_8_1_rangeproof_sign` is set such that
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT size_t rustsecp256k1zkp_v0_8_1_rangeproof_max_size(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  uint64_t max_value,
  int min_bits
