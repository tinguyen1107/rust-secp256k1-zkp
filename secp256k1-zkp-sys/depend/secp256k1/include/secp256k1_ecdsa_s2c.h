 ...
 *  comparison, use rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening_serialize and rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening_parse.
 */
typedef struct {
    unsigned char data[64];
} rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening;
 ...
 *
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening_parse(
 ...
 *  In:   opening: a pointer to an initialized `rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *output33,
    const rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening *opening
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);

/** Same as rustsecp256k1zkp_v0_8_1_ecdsa_sign, but s2c_data32 is committed to inside the nonce
 *
 *  Returns: 1: signature created
 *           0: the nonce generation function failed, or the private key was invalid.
 *  Args:    ctx:  pointer to a context object (not rustsecp256k1zkp_v0_8_1_context_static)
 *  Out:     sig:  pointer to an array where the signature will be placed (cannot be NULL)
 *   s2c_opening:  if non-NULL, pointer to an rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening structure to populate
 *  In:    msg32: the 32-byte message hash being signed (cannot be NULL)
 *        seckey: pointer to a 32-byte secret key (cannot be NULL)
 *    s2c_data32: pointer to a 32-byte data to commit to in the nonce (cannot be NULL)
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ecdsa_s2c_sign(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_ecdsa_s2c_verify_commit(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *     `rustsecp256k1zkp_v0_8_1_ecdsa_anti_exfil_host_commit`. It sends this to the signing device.
 *  2. The signing device computes a public nonce `R` using the host's commitment
 *     as auxiliary randomness, using `rustsecp256k1zkp_v0_8_1_ecdsa_anti_exfil_signer_commit`.
 ...
 *  4. The device signs with `rustsecp256k1zkp_v0_8_1_anti_exfil_sign`, using `rho` as `host_data32`,
 *     and sends the signature to the host.
 *  5. The host verifies that the signature's public nonce matches the opening from
 *     step 2 and its original randomness `rho`, using `rustsecp256k1zkp_v0_8_1_anti_exfil_host_verify`.
 *
 *  Rationale:
 ...
 *                          commitment.
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ecdsa_anti_exfil_host_commit(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ecdsa_anti_exfil_signer_commit(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_ecdsa_s2c_opening *s2c_opening,
    const unsigned char *msg32,
...
/** Same as rustsecp256k1zkp_v0_8_1_ecdsa_sign, but commits to host randomness in the nonce. Part of the
 *  ECDSA Anti-Exfil Protocol.
 *
 *  Returns: 1: signature created
 *           0: the nonce generation function failed, or the private key was invalid.
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_anti_exfil_sign(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_ecdsa_signature *sig,
    const unsigned char *msg32,
    const unsigned char *seckey,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_anti_exfil_host_verify(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    const rustsecp256k1zkp_v0_8_1_ecdsa_signature *sig,
    const unsigned char *msg32,
