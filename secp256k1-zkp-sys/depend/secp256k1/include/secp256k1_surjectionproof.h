 ...
 *
 *  To obtain these properties, instead use rustsecp256k1zkp_v0_8_1_surjectionproof_parse
 *  and rustsecp256k1zkp_v0_8_1_surjectionproof_serialize to encode/decode proofs into a
 *  well-defined format.
 *
...
typedef struct {
#ifdef VERIFY
    /** Mark whether this proof has gone through `rustsecp256k1zkp_v0_8_1_surjectionproof_initialize` */
    int initialized;
#endif
...
} rustsecp256k1zkp_v0_8_1_surjectionproof;
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_surjectionproof_parse(
 ...
 *
 *  See rustsecp256k1zkp_v0_8_1_surjectionproof_parse for details about the encoding.
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_surjectionproof_serialize(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  unsigned char *output,
  size_t *outputlen,
  const rustsecp256k1zkp_v0_8_1_surjectionproof *proof
...
} rustsecp256k1zkp_v0_8_1_fixed_asset_tag;
 ...
 */
SECP256K1_API size_t rustsecp256k1zkp_v0_8_1_surjectionproof_n_total_inputs(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  const rustsecp256k1zkp_v0_8_1_surjectionproof *proof
 ...
 *     proof: a pointer to a proof object
 */
SECP256K1_API size_t rustsecp256k1zkp_v0_8_1_surjectionproof_n_used_inputs(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  const rustsecp256k1zkp_v0_8_1_surjectionproof *proof
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);
 ...
 *     proof: a pointer to a proof object
 */
SECP256K1_API size_t rustsecp256k1zkp_v0_8_1_surjectionproof_serialized_size(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  const rustsecp256k1zkp_v0_8_1_surjectionproof *proof
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);

/** Surjection proof initialization function; decides on inputs to use
 *  To be used to initialize stack-allocated rustsecp256k1zkp_v0_8_1_surjectionproof struct
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_surjectionproof_initialize(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  rustsecp256k1zkp_v0_8_1_surjectionproof *proof,
  size_t *input_index,
  const rustsecp256k1zkp_v0_8_1_fixed_asset_tag *fixed_input_tags,
  const size_t n_input_tags,
  const size_t n_input_tags_to_use,
  const rustsecp256k1zkp_v0_8_1_fixed_asset_tag *fixed_output_tag,
 ...
 *
 * In:               ctx: pointer to a context object
 *           proof_out_p: a pointer to a pointer to `rustsecp256k1zkp_v0_8_1_surjectionproof*`.
 ...
 *          input_index: The index of the actual input that is secretly mapped to the output
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_surjectionproof_allocate_initialized(
        const rustsecp256k1zkp_v0_8_1_context *ctx,
        rustsecp256k1zkp_v0_8_1_surjectionproof **proof_out_p,
        size_t *input_index,
        const rustsecp256k1zkp_v0_8_1_fixed_asset_tag *fixed_input_tags,
        const size_t n_input_tags,
        const size_t n_input_tags_to_use,
 ...
 *  deallocates the struct that was allocated with rustsecp256k1zkp_v0_8_1_surjectionproof_allocate_initialized
 *
 * In:               proof: pointer to rustsecp256k1zkp_v0_8_1_surjectionproof struct
 */
SECP256K1_API void rustsecp256k1zkp_v0_8_1_surjectionproof_destroy(
        rustsecp256k1zkp_v0_8_1_surjectionproof *proof
 ...
 *
 * In:                   ctx: pointer to a context object (not rustsecp256k1zkp_v0_8_1_context_static)
 ...
 * In/Out: proof: The produced surjection proof. Must have already gone through `rustsecp256k1zkp_v0_8_1_surjectionproof_initialize`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_surjectionproof_generate(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  rustsecp256k1zkp_v0_8_1_surjectionproof *proof,
  const rustsecp256k1zkp_v0_8_1_generator *ephemeral_input_tags,
  size_t n_ephemeral_input_tags,
  const rustsecp256k1zkp_v0_8_1_generator *ephemeral_output_tag,
  size_t input_index,
 ...
 *      ephemeral_output_tag: the ephemeral asset tag of the output
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_surjectionproof_verify(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  const rustsecp256k1zkp_v0_8_1_surjectionproof *proof,
  const rustsecp256k1zkp_v0_8_1_generator *ephemeral_input_tags,
  size_t n_ephemeral_input_tags,
