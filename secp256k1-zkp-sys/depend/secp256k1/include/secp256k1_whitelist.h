 ...
 *
 *  To obtain these properties, instead use rustsecp256k1zkp_v0_8_1_whitelist_signature_parse
 *  and rustsecp256k1zkp_v0_8_1_whitelist_signature_serialize to encode/decode signatures
 ...
 *  of keys for a signature, use `rustsecp256k1zkp_v0_8_1_whitelist_signature_n_keys`.
 */
typedef struct {
    size_t n_keys;
    /* e0, scalars */
    unsigned char data[32 * (1 + SECP256K1_WHITELIST_MAX_N_KEYS)];
} rustsecp256k1zkp_v0_8_1_whitelist_signature;
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_whitelist_signature_parse(
 ...
 */
SECP256K1_API size_t rustsecp256k1zkp_v0_8_1_whitelist_signature_n_keys(
    const rustsecp256k1zkp_v0_8_1_whitelist_signature *sig
 ...
 *
 *  See rustsecp256k1zkp_v0_8_1_whitelist_signature_parse for details about the encoding.
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_whitelist_signature_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_whitelist_sign(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  rustsecp256k1zkp_v0_8_1_whitelist_signature *sig,
  const rustsecp256k1zkp_v0_8_1_pubkey *online_pubkeys,
  const rustsecp256k1zkp_v0_8_1_pubkey *offline_pubkeys,
  const size_t n_keys,
  const rustsecp256k1zkp_v0_8_1_pubkey *sub_pubkey,
 ...
 *         sub_pubkey: the key to be whitelisted
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_whitelist_verify(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  const rustsecp256k1zkp_v0_8_1_whitelist_signature *sig,
  const rustsecp256k1zkp_v0_8_1_pubkey *online_pubkeys,
  const rustsecp256k1zkp_v0_8_1_pubkey *offline_pubkeys,
