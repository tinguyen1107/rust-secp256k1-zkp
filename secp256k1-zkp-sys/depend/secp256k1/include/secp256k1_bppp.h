...
typedef struct rustsecp256k1zkp_v0_8_1_bppp_generators rustsecp256k1zkp_v0_8_1_bppp_generators;
 ...
 */
SECP256K1_API rustsecp256k1zkp_v0_8_1_bppp_generators *rustsecp256k1zkp_v0_8_1_bppp_generators_create(
 ...
 *  Args:      ctx: pointer to a context object
 *  In:       data: data that came from `rustsecp256k1zkp_v0_8_1_bppp_generators_serialize`
 *        data_len: the length of the `data` buffer
 */
SECP256K1_API rustsecp256k1zkp_v0_8_1_bppp_generators *rustsecp256k1zkp_v0_8_1_bppp_generators_parse(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_bppp_generators_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    const rustsecp256k1zkp_v0_8_1_bppp_generators *gen,
    unsigned char *data,
    size_t *data_len
 ...
 */
SECP256K1_API void rustsecp256k1zkp_v0_8_1_bppp_generators_destroy(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_bppp_generators *gen
) SECP256K1_ARG_NONNULL(1);
