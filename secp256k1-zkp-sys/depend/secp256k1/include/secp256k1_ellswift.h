...
/** A pointer to a function used by rustsecp256k1zkp_v0_8_1_ellswift_xdh to hash the shared X
 ...
 *           0 will cause rustsecp256k1zkp_v0_8_1_ellswift_xdh to fail and return 0.
 *           Other return values are not allowed, and the behaviour of
 *           rustsecp256k1zkp_v0_8_1_ellswift_xdh is undefined for other return values.
 ...
 */
typedef int (*rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function)(
...
/** An implementation of an rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function which uses
 *  SHA256(prefix64 || ell_a64 || ell_b64 || x32), where prefix64 is the 64-byte
 *  array pointed to by data. */
SECP256K1_API const rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function_prefix;

/** An implementation of an rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function compatible with
 ...
 *  to rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function_prefix with prefix64 set to
 *  SHA256("bip324_ellswift_xonly_ecdh")||SHA256("bip324_ellswift_xonly_ecdh").
 *  The data argument is ignored. */
SECP256K1_API const rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function_bip324;
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ellswift_encode(
 ...
 *  Returns: always 1
 *  Args:    ctx:        pointer to a context object
 *  Out:     pubkey:     pointer to a rustsecp256k1zkp_v0_8_1_pubkey that will be filled
 *  In:      ell64:      pointer to a 64-byte array to decode
 *
 * This function runs in variable time.
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ellswift_decode(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 * argument to rustsecp256k1zkp_v0_8_1_ellswift_encode in this regard.
 *
 * This function can be used instead of calling rustsecp256k1zkp_v0_8_1_ec_pubkey_create
 * followed by rustsecp256k1zkp_v0_8_1_ellswift_encode. It is safer, as it uses the secret
 * key as entropy for the encoding (supplemented with auxrnd32, if provided).
 *
 * Like rustsecp256k1zkp_v0_8_1_ellswift_encode, this function does not guarantee that the
 * computed encoding is stable across versions of the library, even if all
 * arguments (including auxrnd32) are the same.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_ellswift_create(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *ell64,
 ...
 * ECDH on them.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_ellswift_xdh(
  const rustsecp256k1zkp_v0_8_1_context *ctx,
  unsigned char *output,
  const unsigned char *ell_a64,
  const unsigned char *ell_b64,
  const unsigned char *seckey32,
  int party,
  rustsecp256k1zkp_v0_8_1_ellswift_xdh_hash_function hashfp,
  void *data
