 ...
 *
 *  Same as rustsecp256k1zkp_v0_8_1_nonce_function_hardened with the exception of using the
 ...
 */
typedef int (*rustsecp256k1zkp_v0_8_1_nonce_function_hardened_ecdsa_adaptor)(
 ...
 */
SECP256K1_API const rustsecp256k1zkp_v0_8_1_nonce_function_hardened_ecdsa_adaptor rustsecp256k1zkp_v0_8_1_nonce_function_ecdsa_adaptor;
 ...
 *                         rustsecp256k1zkp_v0_8_1_nonce_function_ecdsa_adaptor is used
 *                  ndata: pointer to arbitrary data used by the nonce generation
 *                         function (can be NULL). If it is non-NULL and
 *                         rustsecp256k1zkp_v0_8_1_nonce_function_ecdsa_adaptor is used, then
 *                         ndata must be a pointer to 32-byte auxiliary randomness
 *                         as per BIP-340.
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *adaptor_sig162,
    unsigned char *seckey32,
    const rustsecp256k1zkp_v0_8_1_pubkey *enckey,
    const unsigned char *msg32,
    rustsecp256k1zkp_v0_8_1_nonce_function_hardened_ecdsa_adaptor noncefp,
    void *ndata
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *                 enckey: pointer to the adaptor encryption public key
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
