...
} rustsecp256k1zkp_v0_8_1_musig_keyagg_cache;
...
} rustsecp256k1zkp_v0_8_1_musig_secnonce;
...
typedef struct {
    unsigned char data[132];
} rustsecp256k1zkp_v0_8_1_musig_pubnonce;
...
typedef struct {
    unsigned char data[132];
} rustsecp256k1zkp_v0_8_1_musig_aggnonce;
...
} rustsecp256k1zkp_v0_8_1_musig_session;
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_pubnonce_parse(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_musig_pubnonce *nonce,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_pubnonce_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *out66,
    const rustsecp256k1zkp_v0_8_1_musig_pubnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:     in66: pointer to the 66-byte nonce to be parsed
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_aggnonce_parse(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_musig_aggnonce *nonce,
    const unsigned char *in66
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:    nonce: pointer to the nonce
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_aggnonce_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *out66,
    const rustsecp256k1zkp_v0_8_1_musig_aggnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_partial_sig_serialize(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *out32,
    const rustsecp256k1zkp_v0_8_1_musig_partial_sig *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_partial_sig_parse(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_musig_partial_sig *sig,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_get_keyaggcoef_and_negation_seckey(
    const rustsecp256k1zkp_v0_8_1_context* ctx,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_negate_seckey(
    const rustsecp256k1zkp_v0_8_1_context* ctx,
...
SECP256K1_API int rustsecp256k1zkp_v0_8_1_blinded_musig_pubkey_xonly_tweak_add(
    const rustsecp256k1zkp_v0_8_1_context* ctx, 
 ...
 *
 *  Before aggregating, the pubkeys can be sorted with `rustsecp256k1zkp_v0_8_1_pubkey_sort`
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_pubkey_agg(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    ...
    const rustsecp256k1zkp_v0_8_1_pubkey * const *pubkeys,
    size_t n_pubkeys
 ...
 *                    `musig_pubkey_agg`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_musig_pubkey_get(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *
 *  The tweaking method is the same as `rustsecp256k1zkp_v0_8_1_ec_pubkey_tweak_add`. So after
 *  the following pseudocode buf and buf2 have identical contents (absent
 *  earlier failures).
 *
 *  rustsecp256k1zkp_v0_8_1_musig_pubkey_agg(..., keyagg_cache, pubkeys, ...)
 *  rustsecp256k1zkp_v0_8_1_musig_pubkey_get(..., agg_pk, keyagg_cache)
 *  rustsecp256k1zkp_v0_8_1_musig_pubkey_ec_tweak_add(..., output_pk, tweak32, keyagg_cache)
 *  rustsecp256k1zkp_v0_8_1_ec_pubkey_serialize(..., buf, output_pk)
 *  rustsecp256k1zkp_v0_8_1_ec_pubkey_tweak_add(..., agg_pk, tweak32)
 *  rustsecp256k1zkp_v0_8_1_ec_pubkey_serialize(..., buf2, agg_pk)
 *
 *  This function is required if you want to _sign_ for a tweaked aggregate key.
 *  On the other hand, if you are only computing a public key, but not intending
 *  to create a signature for it, you can just use
 *  `rustsecp256k1zkp_v0_8_1_ec_pubkey_tweak_add`.
 *
 ...
 *                        according to `rustsecp256k1zkp_v0_8_1_ec_seckey_verify`, this function
 *                        returns 0. For uniformly random 32-byte arrays the
 *                        chance of being invalid is negligible (around 1 in
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_musig_pubkey_ec_tweak_add(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_pubkey *output_pubkey,
    rustsecp256k1zkp_v0_8_1_musig_keyagg_cache *keyagg_cache,
    const unsigned char *tweak32
 ...
 *  Taproot outputs.
 *
 *  The tweaking method is the same as `rustsecp256k1zkp_v0_8_1_xonly_pubkey_tweak_add`. So in
 *  the following pseudocode xonly_pubkey_tweak_add_check (absent earlier
 *  failures) returns 1.
 *
 *  rustsecp256k1zkp_v0_8_1_musig_pubkey_agg(..., agg_pk, keyagg_cache, pubkeys, ...)
 *  rustsecp256k1zkp_v0_8_1_musig_pubkey_xonly_tweak_add(..., output_pk, tweak32, keyagg_cache)
 *  rustsecp256k1zkp_v0_8_1_xonly_pubkey_serialize(..., buf, output_pk)
 *  rustsecp256k1zkp_v0_8_1_xonly_pubkey_tweak_add_check(..., buf, ..., agg_pk, tweak32)
 *
 *  This function is required if you want to _sign_ for a tweaked aggregate key.
 *  On the other hand, if you are only computing a public key, but not intending
 *  to create a signature for it, you can just use
 *  `rustsecp256k1zkp_v0_8_1_xonly_pubkey_tweak_add`.
 *
 *  Returns: 0 if the arguments are invalid or the resulting public key would be
 *           invalid (only when the tweak is the negation of the corresponding
 *           secret key). 1 otherwise.
 ...
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_musig_pubkey_xonly_tweak_add(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_pubkey *output_pubkey,
    rustsecp256k1zkp_v0_8_1_musig_keyagg_cache *keyagg_cache,
    const unsigned char *tweak32
 ...
 *                     call to rustsecp256k1zkp_v0_8_1_musig_nonce_gen and must be uniformly random
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_nonce_gen(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *                       greater than 0.
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_nonce_agg(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    rustsecp256k1zkp_v0_8_1_musig_aggnonce  *aggnonce,
    const rustsecp256k1zkp_v0_8_1_musig_pubnonce * const *pubnonces,
    size_t n_pubnonces
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_musig_nonce_process(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
...
/** Takes the public nonces of all signers and computes a session that is
 *  required for signing and verification of partial signatures.
 *  This function is identical to `rustsecp256k1zkp_v0_8_1_musig_nonce_process` except that
 ...
 *  signature with `rustsecp256k1zkp_v0_8_1_musig_partial_sig_verify` to prevent random or
 ...
 *                     musig_nonce_process
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_partial_sign(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *                    `musig_nonce_process`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_musig_partial_sig_verify(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
 ...
 *                    `musig_nonce_process`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_blinded_musig_partial_sig_verify(
    const rustsecp256k1zkp_v0_8_1_context* ctx, 
    const rustsecp256k1zkp_v0_8_1_musig_partial_sig *partial_sig, 
    const rustsecp256k1zkp_v0_8_1_musig_pubnonce *pubnonce, 
    const rustsecp256k1zkp_v0_8_1_pubkey *pubkey, 
 ...
 *                     greater than 0.
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_partial_sig_agg(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *sig64,
    const rustsecp256k1zkp_v0_8_1_musig_session *session,
    const rustsecp256k1zkp_v0_8_1_musig_partial_sig * const *partial_sigs,
    size_t n_sigs
 ...
 *                     musig_nonce_process
 */
SECP256K1_API int rustsecp256k1zkp_v0_8_1_musig_nonce_parity(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    int *nonce_parity,
    const rustsecp256k1zkp_v0_8_1_musig_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_musig_adapt(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
    unsigned char *sig64,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_8_1_musig_extract_adaptor(
    const rustsecp256k1zkp_v0_8_1_context *ctx,
