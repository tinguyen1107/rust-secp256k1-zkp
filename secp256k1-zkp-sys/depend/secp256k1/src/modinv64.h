...
typedef struct {
    int64_t v[5];
} rustsecp256k1zkp_v0_8_1_modinv64_signed62;

typedef struct {
    /* The modulus in signed62 notation, must be odd and in [3, 2^256]. */
    rustsecp256k1zkp_v0_8_1_modinv64_signed62 modulus;

    /* modulus^{-1} mod 2^62 */
    uint64_t modulus_inv62;
} rustsecp256k1zkp_v0_8_1_modinv64_modinfo;
...
/* Same as rustsecp256k1zkp_v0_8_1_modinv64_var, but constant time in x (not in the modulus). */
