...
static const rustsecp256k1zkp_v0_8_1_scalar rustsecp256k1zkp_v0_8_1_scalar_one = SECP256K1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 1);
static const rustsecp256k1zkp_v0_8_1_scalar rustsecp256k1zkp_v0_8_1_scalar_zero = SECP256K1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 0);

static int rustsecp256k1zkp_v0_8_1_scalar_set_b32_seckey(rustsecp256k1zkp_v0_8_1_scalar *r, const unsigned char *bin) {
    int overflow;
    rustsecp256k1zkp_v0_8_1_scalar_set_b32(r, bin, &overflow);
    return (!overflow) & (!rustsecp256k1zkp_v0_8_1_scalar_is_zero(r));
}
 ...
 * lambda is: */
static const rustsecp256k1zkp_v0_8_1_scalar rustsecp256k1zkp_v0_8_1_const_lambda = SECP256K1_SCALAR_CONST(
    0x5363AD4CUL, 0xC05C30E0UL, 0xA5261C02UL, 0x8812645AUL,
    0x122E22EAUL, 0x20816678UL, 0xDF02967CUL, 0x1B23BD72UL
);

#ifdef VERIFY
static void rustsecp256k1zkp_v0_8_1_scalar_split_lambda_verify(const rustsecp256k1zkp_v0_8_1_scalar *r1, const rustsecp256k1zkp_v0_8_1_scalar *r2, const rustsecp256k1zkp_v0_8_1_scalar *k);
#endif
 ...
 */
static void rustsecp256k1zkp_v0_8_1_scalar_split_lambda(rustsecp256k1zkp_v0_8_1_scalar * SECP256K1_RESTRICT r1, rustsecp256k1zkp_v0_8_1_scalar * SECP256K1_RESTRICT r2, const rustsecp256k1zkp_v0_8_1_scalar * SECP256K1_RESTRICT k) {
    rustsecp256k1zkp_v0_8_1_scalar c1, c2;
    static const rustsecp256k1zkp_v0_8_1_scalar minus_b1 = SECP256K1_SCALAR_CONST(
        0x00000000UL, 0x00000000UL, 0x00000000UL, 0x00000000UL,
        0xE4437ED6UL, 0x010E8828UL, 0x6F547FA9UL, 0x0ABFE4C3UL
    );
    static const rustsecp256k1zkp_v0_8_1_scalar minus_b2 = SECP256K1_SCALAR_CONST(
        0xFFFFFFFFUL, 0xFFFFFFFFUL, 0xFFFFFFFFUL, 0xFFFFFFFEUL,
        0x8A280AC5UL, 0x0774346DUL, 0xD765CDA8UL, 0x3DB1562CUL
    );
    static const rustsecp256k1zkp_v0_8_1_scalar g1 = SECP256K1_SCALAR_CONST(
        0x3086D221UL, 0xA7D46BCDUL, 0xE86C90E4UL, 0x9284EB15UL,
        0x3DAA8A14UL, 0x71E8CA7FUL, 0xE893209AUL, 0x45DBB031UL
    );
    static const rustsecp256k1zkp_v0_8_1_scalar g2 = SECP256K1_SCALAR_CONST(
    ...
    rustsecp256k1zkp_v0_8_1_scalar_mul_shift_var(&c1, k, &g1, 384);
    rustsecp256k1zkp_v0_8_1_scalar_mul_shift_var(&c2, k, &g2, 384);
    rustsecp256k1zkp_v0_8_1_scalar_mul(&c1, &c1, &minus_b1);
    rustsecp256k1zkp_v0_8_1_scalar_mul(&c2, &c2, &minus_b2);
    rustsecp256k1zkp_v0_8_1_scalar_add(r2, &c1, &c2);
    rustsecp256k1zkp_v0_8_1_scalar_mul(r1, r2, &rustsecp256k1zkp_v0_8_1_const_lambda);
    rustsecp256k1zkp_v0_8_1_scalar_negate(r1, r1);
    rustsecp256k1zkp_v0_8_1_scalar_add(r1, r1, k);

#ifdef VERIFY
    rustsecp256k1zkp_v0_8_1_scalar_split_lambda_verify(r1, r2, k);
#endif
}

#ifdef VERIFY
/*
 * Proof for rustsecp256k1zkp_v0_8_1_scalar_split_lambda's bounds.
 *
 * Let
...
static void rustsecp256k1zkp_v0_8_1_scalar_split_lambda_verify(const rustsecp256k1zkp_v0_8_1_scalar *r1, const rustsecp256k1zkp_v0_8_1_scalar *r2, const rustsecp256k1zkp_v0_8_1_scalar *k) {
    ...
    rustsecp256k1zkp_v0_8_1_scalar_mul(&s, &rustsecp256k1zkp_v0_8_1_const_lambda, r2);
    rustsecp256k1zkp_v0_8_1_scalar_add(&s, &s, r1);
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_scalar_eq(&s, k));

    rustsecp256k1zkp_v0_8_1_scalar_negate(&s, r1);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(buf1, r1);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(buf1, k1_bound, 32) < 0 || rustsecp256k1zkp_v0_8_1_memcmp_var(buf2, k1_bound, 32) < 0);

    rustsecp256k1zkp_v0_8_1_scalar_negate(&s, r2);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(buf1, r2);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(buf1, k2_bound, 32) < 0 || rustsecp256k1zkp_v0_8_1_memcmp_var(buf2, k2_bound, 32) < 0);
}
#endif /* VERIFY */
