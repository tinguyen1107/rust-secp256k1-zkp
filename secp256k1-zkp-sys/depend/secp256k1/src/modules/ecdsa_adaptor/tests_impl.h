...
static void rand_scalar(rustsecp256k1zkp_v0_8_1_scalar *scalar) {
    unsigned char buf32[32];
    rustsecp256k1zkp_v0_8_1_testrand256(buf32);
    rustsecp256k1zkp_v0_8_1_scalar_set_b32(scalar, buf32, NULL);
}

static void rand_point(rustsecp256k1zkp_v0_8_1_ge *point) {
    rustsecp256k1zkp_v0_8_1_scalar x;
    rustsecp256k1zkp_v0_8_1_gej pointj;
    rand_scalar(&x);

    rustsecp256k1zkp_v0_8_1_ecmult_gen(&CTX->ecmult_gen_ctx, &pointj, &x);
    rustsecp256k1zkp_v0_8_1_ge_set_gej(point, &pointj);
}

static void dleq_nonce_bitflip(unsigned char **args, size_t n_flip, size_t n_bytes) {
    rustsecp256k1zkp_v0_8_1_scalar k1, k2;

    CHECK(rustsecp256k1zkp_v0_8_1_dleq_nonce(&k1, args[0], args[1], args[2], args[3], NULL, args[4]) == 1);
    rustsecp256k1zkp_v0_8_1_testrand_flip(args[n_flip], n_bytes);
    CHECK(rustsecp256k1zkp_v0_8_1_dleq_nonce(&k2, args[0], args[1], args[2], args[3], NULL, args[4]) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_scalar_eq(&k1, &k2) == 0);
}

static void dleq_tests(void) {
    rustsecp256k1zkp_v0_8_1_scalar s, e, sk, k;
    rustsecp256k1zkp_v0_8_1_ge gen2, p1, p2;
    ...
    rand_point(&gen2);
    rand_scalar(&sk);
    rustsecp256k1zkp_v0_8_1_dleq_pair(&CTX->ecmult_gen_ctx, &p1, &p2, &sk, &gen2);
    CHECK(rustsecp256k1zkp_v0_8_1_dleq_prove(CTX, &s, &e, &sk, &gen2, &p1, &p2, NULL, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_dleq_verify(&s, &e, &p1, &gen2, &p2) == 1);

    {
        rustsecp256k1zkp_v0_8_1_scalar tmp;
        rustsecp256k1zkp_v0_8_1_scalar_set_int(&tmp, 1);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_verify(&tmp, &e, &p1, &gen2, &p2) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_verify(&s, &tmp, &p1, &gen2, &p2) == 0);
    }
    {
        rustsecp256k1zkp_v0_8_1_ge p_tmp;
        rand_point(&p_tmp);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_verify(&s, &e, &p_tmp, &gen2, &p2) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_verify(&s, &e, &p1, &p_tmp, &p2) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_verify(&s, &e, &p1, &gen2, &p_tmp) == 0);
    }
    {
        rustsecp256k1zkp_v0_8_1_ge p_inf;
        rustsecp256k1zkp_v0_8_1_ge_set_infinity(&p_inf);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_prove(CTX, &s, &e, &sk, &p_inf, &p1, &p2, NULL, NULL) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_prove(CTX, &s, &e, &sk, &gen2, &p_inf, &p2, NULL, NULL) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_dleq_prove(CTX, &s, &e, &sk, &gen2, &p1, &p_inf, NULL, NULL) == 0);
    }

    /* Nonce tests */
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(sk32, &sk);
    CHECK(rustsecp256k1zkp_v0_8_1_eckey_pubkey_serialize(&gen2, gen2_33, &pubkey_size, 1));
    CHECK(rustsecp256k1zkp_v0_8_1_eckey_pubkey_serialize(&p1, p1_33, &pubkey_size, 1));
    CHECK(rustsecp256k1zkp_v0_8_1_eckey_pubkey_serialize(&p2, p2_33, &pubkey_size, 1));
    CHECK(rustsecp256k1zkp_v0_8_1_dleq_nonce(&k, sk32, gen2_33, p1_33, p2_33, NULL, NULL) == 1);

    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(sk32, sizeof(sk32));
    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(gen2_33, sizeof(gen2_33));
    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(p1_33, sizeof(p1_33));
    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(p2_33, sizeof(p2_33));
    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(aux_rand, sizeof(aux_rand));
...
static void rand_flip_bit(unsigned char *array, size_t n) {
    array[rustsecp256k1zkp_v0_8_1_testrand_int(n)] ^= 1 << rustsecp256k1zkp_v0_8_1_testrand_int(8);
}
...
static void test_ecdsa_adaptor_spec_vectors_check_verify(const unsigned char *adaptor_sig162, const unsigned char *msg32, const unsigned char *pubkey33, const unsigned char *encryption_key33, int expected) {
    ...
    rustsecp256k1zkp_v0_8_1_ge pubkey_ge;
    rustsecp256k1zkp_v0_8_1_pubkey encryption_key;
    rustsecp256k1zkp_v0_8_1_ge encryption_key_ge;

    CHECK(rustsecp256k1zkp_v0_8_1_eckey_pubkey_parse(&encryption_key_ge, encryption_key33, 33) == 1);
    rustsecp256k1zkp_v0_8_1_pubkey_save(&encryption_key, &encryption_key_ge);
    CHECK(rustsecp256k1zkp_v0_8_1_eckey_pubkey_parse(&pubkey_ge, pubkey33, 33) == 1);
    rustsecp256k1zkp_v0_8_1_pubkey_save(&pubkey, &pubkey_ge);

    CHECK(expected == rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, adaptor_sig162, &pubkey, msg32, &encryption_key));
}
...
static void test_ecdsa_adaptor_spec_vectors_check_decrypt(const unsigned char *adaptor_sig162, const unsigned char *decryption_key32, const unsigned char *signature64, int expected) {
    ...
    rustsecp256k1zkp_v0_8_1_ecdsa_signature s;

    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &s, decryption_key32, adaptor_sig162) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_signature_serialize_compact(CTX, signature, &s) == 1);

    CHECK(expected == !(rustsecp256k1zkp_v0_8_1_memcmp_var(signature, signature64, 64)));
}
...
static void test_ecdsa_adaptor_spec_vectors_check_recover(const unsigned char *adaptor_sig162, const unsigned char *encryption_key33, const unsigned char *decryption_key32, const unsigned char *signature64, int expected) {
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_signature_parse_compact(CTX, &sig, signature64) == 1);
    CHECK(expected == rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, deckey32, &sig, adaptor_sig162, &encryption_key));
    if (decryption_key32 != NULL) {
        CHECK(expected == !(rustsecp256k1zkp_v0_8_1_memcmp_var(deckey32, decryption_key32, 32)));
    }
}
...
static void test_ecdsa_adaptor_spec_vectors_check_serialization(const unsigned char *adaptor_sig162, int expected) {
    ...
    rustsecp256k1zkp_v0_8_1_scalar dleq_proof_s, dleq_proof_e;
    rustsecp256k1zkp_v0_8_1_ge r, rp;
    rustsecp256k1zkp_v0_8_1_scalar sp;
    rustsecp256k1zkp_v0_8_1_scalar sigr;

    CHECK(expected == rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(&r, &sigr, &rp, &sp, &dleq_proof_e, &dleq_proof_s, adaptor_sig162));
    if (expected == 1) {
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_serialize(buf, &r, &rp, &sp, &dleq_proof_e, &dleq_proof_s) == 1);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(buf, adaptor_sig162, 162) == 0);
    }
}
...
static void nonce_function_ecdsa_adaptor_bitflip(unsigned char **args, size_t n_flip, size_t n_bytes, size_t algolen) {
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(nonces[0], nonces[1], 32) != 0);
}

/* Tests for the equality of two sha256 structs. This function only produces a
 * correct result if an integer multiple of 64 many bytes have been written
 * into the hash functions. */
static void ecdsa_adaptor_test_sha256_eq(const rustsecp256k1zkp_v0_8_1_sha256 *sha1, const rustsecp256k1zkp_v0_8_1_sha256 *sha2) {
...
static void run_nonce_function_ecdsa_adaptor_tests(void) {
    ...
    rustsecp256k1zkp_v0_8_1_sha256 sha_optimized;
     ...
     * rustsecp256k1zkp_v0_8_1_nonce_function_ecdsa_adaptor_sha256_tagged has the expected
     * state. */
    rustsecp256k1zkp_v0_8_1_sha256_initialize_tagged(&sha, tag, sizeof(tag));
    rustsecp256k1zkp_v0_8_1_nonce_function_ecdsa_adaptor_sha256_tagged(&sha_optimized);
    ecdsa_adaptor_test_sha256_eq(&sha, &sha_optimized);

   /* Check that hash initialized by
    * rustsecp256k1zkp_v0_8_1_nonce_function_ecdsa_adaptor_sha256_tagged_aux has the expected
    * state. */
    rustsecp256k1zkp_v0_8_1_sha256_initialize_tagged(&sha, aux_tag, sizeof(aux_tag));
    rustsecp256k1zkp_v0_8_1_nonce_function_ecdsa_adaptor_sha256_tagged_aux(&sha_optimized);
    ecdsa_adaptor_test_sha256_eq(&sha, &sha_optimized);

   /* Check that hash initialized by
    * rustsecp256k1zkp_v0_8_1_nonce_function_dleq_sha256_tagged_aux has the expected
    * state. */
    rustsecp256k1zkp_v0_8_1_sha256_initialize_tagged(&sha, dleq_tag, sizeof(dleq_tag));
    rustsecp256k1zkp_v0_8_1_nonce_function_dleq_sha256_tagged(&sha_optimized);
    ecdsa_adaptor_test_sha256_eq(&sha, &sha_optimized);

    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(msg, sizeof(msg));
    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(key, sizeof(key));
    ...
    for (i = 0; i < COUNT; i++) {
        ...
        uint32_t offset = rustsecp256k1zkp_v0_8_1_testrand_int(algolen - 1);
...
static void test_ecdsa_adaptor_api(void) {
    rustsecp256k1zkp_v0_8_1_pubkey pubkey;
    rustsecp256k1zkp_v0_8_1_pubkey enckey;
    rustsecp256k1zkp_v0_8_1_pubkey zero_pk;
    rustsecp256k1zkp_v0_8_1_ecdsa_signature sig;
    unsigned char sk[32];
    unsigned char msg[32];
    ...
    rustsecp256k1zkp_v0_8_1_testrand256(sk);
    rustsecp256k1zkp_v0_8_1_testrand256(msg);
    rustsecp256k1zkp_v0_8_1_testrand256(deckey);
    CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &pubkey, sk) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &enckey, deckey) == 1);
    memset(&zero_pk, 0, sizeof(zero_pk));

    /** main test body **/
    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig, sk, &enckey, msg, NULL, NULL) == 1);
    CHECK(ecount == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(STATIC_CTX, asig, sk, &enckey, msg, NULL, NULL) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, NULL, sk, &enckey, msg, NULL, NULL) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig, sk, &enckey, NULL, NULL, NULL) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig, NULL, &enckey, msg, NULL, NULL) == 0);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig, sk, NULL, msg, NULL, NULL) == 0);
    CHECK(ecount == 5);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig, sk, &zero_pk, msg, NULL, NULL) == 0);
    CHECK(ecount == 6);

    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig, sk, &enckey, msg, NULL, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig, &pubkey, msg, &enckey) == 1);
    CHECK(ecount == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, NULL, &pubkey, msg, &enckey) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig, &pubkey, NULL, &enckey) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig, &pubkey, msg, NULL) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig, NULL, msg, &enckey) == 0);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig, &zero_pk, msg, &enckey) == 0);
    CHECK(ecount == 5);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig, &pubkey, msg, &zero_pk) == 0);
    CHECK(ecount == 6);

    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig, deckey, asig) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig, deckey, asig) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, NULL, deckey, asig) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig, NULL, asig) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig, deckey, NULL) == 0);
    CHECK(ecount == 3);

    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig, deckey, asig) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, deckey, &sig, asig, &enckey) == 1);
    CHECK(ecount == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(STATIC_CTX, deckey, &sig, asig, &enckey) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, NULL, &sig, asig, &enckey) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, deckey, NULL, asig, &enckey) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, deckey, &sig, NULL, &enckey) == 0);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, deckey, &sig, asig, NULL) == 0);
    CHECK(ecount == 5);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, deckey, &sig, asig, &zero_pk) == 0);
    CHECK(ecount == 6);
...
static void adaptor_tests(void) {
    ...
    rustsecp256k1zkp_v0_8_1_testrand256(seckey);
    rustsecp256k1zkp_v0_8_1_testrand256(msg);
    rustsecp256k1zkp_v0_8_1_testrand256(deckey);

    CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &pubkey, seckey) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &enckey, deckey) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, NULL, NULL) == 1);

    {
        /* Test overflowing seckey */
        memset(big, 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, adaptor_sig, big, &enckey, msg, NULL, NULL) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) == 0);

        /* Test different nonce functions */
        memset(adaptor_sig, 1, sizeof(adaptor_sig));
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, ecdsa_adaptor_nonce_function_failing, NULL) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) == 0);
        memset(&adaptor_sig, 1, sizeof(adaptor_sig));
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, ecdsa_adaptor_nonce_function_0, NULL) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, adaptor_sig, seckey, &enckey, msg, ecdsa_adaptor_nonce_function_overflowing, NULL) == 1);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(adaptor_sig, zeros162, sizeof(adaptor_sig)) != 0);
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(&r, &sigr, &rp, &sp, &dleq_proof_e, &dleq_proof_s, adaptor_sig) == 1);

        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_serialize(adaptor_sig_tmp, &r, &rp, &sp, &dleq_proof_e, &dleq_proof_s) == 1);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp)) == 0);

        /* Test adaptor_sig_serialize points at infinity */
        rustsecp256k1zkp_v0_8_1_ge_set_infinity(&p_inf);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_serialize(adaptor_sig_tmp, &p_inf, &rp, &sp, &dleq_proof_e, &dleq_proof_s) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_serialize(adaptor_sig_tmp, &r, &p_inf, &sp, &dleq_proof_e, &dleq_proof_s) == 0);
    }
    {
        ...
        /* r */
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(&r, &sigr, NULL, NULL, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[0], 0xFF, 33);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(&r, &sigr, NULL, NULL, NULL, NULL, adaptor_sig_tmp) == 0);

        /* sigr */
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[1], 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig_tmp) == 1);
        memset(&adaptor_sig_tmp[1], 0, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig_tmp) == 0);

        /* rp */
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, &rp, NULL, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[33], 0xFF, 33);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, &rp, NULL, NULL, NULL, adaptor_sig_tmp) == 0);

        /* sp */
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, &sp, NULL, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[66], 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, &sp, NULL, NULL, adaptor_sig_tmp) == 0);

        /* dleq_proof_e */
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, &dleq_proof_e, NULL, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[98], 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, &dleq_proof_e, NULL, adaptor_sig_tmp) == 1);

        /* dleq_proof_s */
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, NULL, &dleq_proof_s, adaptor_sig) == 1);
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[130], 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, NULL, NULL, NULL, NULL, &dleq_proof_s, adaptor_sig_tmp) == 0);
    }

    /* Test adaptor_sig_verify */
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, adaptor_sig, &pubkey, msg, &enckey) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, adaptor_sig, &enckey, msg, &enckey) == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, adaptor_sig, &pubkey, msg, &pubkey) == 0);
    {
        /* Test failed adaptor sig deserialization */
        unsigned char adaptor_sig_tmp[162];
        memset(&adaptor_sig_tmp, 0xFF, 162);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, adaptor_sig_tmp, &pubkey, msg, &enckey) == 0);
    }
    {
    ...
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, adaptor_sig, &pubkey, msg_tmp, &enckey) == 0);
    }
    {
        ...
        rustsecp256k1zkp_v0_8_1_scalar sigr, t, m;

        /* m := t * sigr */
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_sig_deserialize(NULL, &sigr, NULL, NULL, NULL, NULL, adaptor_sig) == 1);
        rustsecp256k1zkp_v0_8_1_scalar_set_b32(&t, target, NULL);
        rustsecp256k1zkp_v0_8_1_scalar_mul(&m, &t, &sigr);
        rustsecp256k1zkp_v0_8_1_scalar_get_b32(msg_tmp, &m);

        /* X := G */
        seckey_tmp[31] = 1;
        CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &pubkey_tmp, seckey_tmp) == 1);

        /* sp := sigr */
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memcpy(&adaptor_sig_tmp[66], &adaptor_sig_tmp[1], 32);

        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, adaptor_sig_tmp, &pubkey_tmp, msg_tmp, &enckey) == 0);
    }

    /* Test decryption */
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig, deckey, adaptor_sig) == 1);
...

    {
        ...
        rustsecp256k1zkp_v0_8_1_ecdsa_signature s;
        memset(big, 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &s, big, adaptor_sig) == 0);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(&s.data[0], zeros64, sizeof(&s.data[0])) == 0);
    }
    {
        /* Test key recover */
        ...
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, decryption_key_tmp, &sig, adaptor_sig, &enckey) == 1);
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(deckey, decryption_key_tmp, sizeof(deckey)) == 0);

        /* Test failed sp deserialization */
        memcpy(adaptor_sig_tmp, adaptor_sig, sizeof(adaptor_sig_tmp));
        memset(&adaptor_sig_tmp[66], 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, decryption_key_tmp, &sig, adaptor_sig_tmp, &enckey) == 0);
    }
}
...
static void multi_hop_lock_tests(void) {
    ...
    rustsecp256k1zkp_v0_8_1_pubkey pubkey_pop;
    rustsecp256k1zkp_v0_8_1_pubkey pubkey_a, pubkey_b;
    rustsecp256k1zkp_v0_8_1_pubkey l, r;
    rustsecp256k1zkp_v0_8_1_ge l_ge, r_ge;
    rustsecp256k1zkp_v0_8_1_scalar t1, t2, tp;
    rustsecp256k1zkp_v0_8_1_scalar deckey;
    rustsecp256k1zkp_v0_8_1_ecdsa_signature sig_ab, sig_bc;

    rustsecp256k1zkp_v0_8_1_testrand256(seckey_a);
    rustsecp256k1zkp_v0_8_1_testrand256(seckey_b);

    CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &pubkey_a, seckey_a));
    CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &pubkey_b, seckey_b));

    /* Carol setup */
    /* Proof of payment */
    rustsecp256k1zkp_v0_8_1_testrand256(pop);
    CHECK(rustsecp256k1zkp_v0_8_1_ec_pubkey_create(CTX, &pubkey_pop, pop));

    /* Alice setup */
    rustsecp256k1zkp_v0_8_1_testrand256(tx_ab);
    rand_scalar(&t1);
    rand_scalar(&t2);
    rustsecp256k1zkp_v0_8_1_scalar_add(&tp, &t1, &t2);
    /* Left lock */
    rustsecp256k1zkp_v0_8_1_pubkey_load(CTX, &l_ge, &pubkey_pop);
    CHECK(rustsecp256k1zkp_v0_8_1_eckey_pubkey_tweak_add(&l_ge, &t1));
    rustsecp256k1zkp_v0_8_1_pubkey_save(&l, &l_ge);
    /* Right lock */
    rustsecp256k1zkp_v0_8_1_pubkey_load(CTX, &r_ge, &pubkey_pop);
    CHECK(rustsecp256k1zkp_v0_8_1_eckey_pubkey_tweak_add(&r_ge, &tp));
    rustsecp256k1zkp_v0_8_1_pubkey_save(&r, &r_ge);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig_ab, seckey_a, &l, tx_ab, NULL, NULL));

    /* Bob setup */
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig_ab, &pubkey_a, tx_ab, &l));
    rustsecp256k1zkp_v0_8_1_testrand256(tx_bc);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_encrypt(CTX, asig_bc, seckey_b, &r, tx_bc, NULL, NULL));

    /* Carol decrypt */
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_verify(CTX, asig_bc, &pubkey_b, tx_bc, &r));
    rustsecp256k1zkp_v0_8_1_scalar_set_b32(&deckey, pop, NULL);
    rustsecp256k1zkp_v0_8_1_scalar_add(&deckey, &deckey, &tp);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(buf, &deckey);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig_bc, buf, asig_bc));
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_verify(CTX, &sig_bc, tx_bc, &pubkey_b));

    /* Bob recover and decrypt */
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, buf, &sig_bc, asig_bc, &r));
    rustsecp256k1zkp_v0_8_1_scalar_set_b32(&deckey, buf, NULL);
    rustsecp256k1zkp_v0_8_1_scalar_negate(&t2, &t2);
    rustsecp256k1zkp_v0_8_1_scalar_add(&deckey, &deckey, &t2);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(buf, &deckey);
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_decrypt(CTX, &sig_ab, buf, asig_ab));
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_verify(CTX, &sig_ab, tx_ab, &pubkey_a));

    /* Alice recover and derive proof of payment */
    CHECK(rustsecp256k1zkp_v0_8_1_ecdsa_adaptor_recover(CTX, buf, &sig_ab, asig_ab, &l));
    rustsecp256k1zkp_v0_8_1_scalar_set_b32(&deckey, buf, NULL);
    rustsecp256k1zkp_v0_8_1_scalar_negate(&t1, &t1);
    rustsecp256k1zkp_v0_8_1_scalar_add(&deckey, &deckey, &t1);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(buf, &deckey);
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(buf, pop, 32) == 0);
}
