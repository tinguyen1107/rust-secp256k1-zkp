...
static void run_nonce_function_bip340_tests(void) {
     ...
     * rustsecp256k1zkp_v0_8_1_nonce_function_bip340_sha256_tagged has the expected
     * state. */
    rustsecp256k1zkp_v0_8_1_sha256_initialize_tagged(&sha, tag, sizeof(tag));
    rustsecp256k1zkp_v0_8_1_nonce_function_bip340_sha256_tagged(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);

   /* Check that hash initialized by
    * rustsecp256k1zkp_v0_8_1_nonce_function_bip340_sha256_tagged_aux has the expected
    * state. */
    rustsecp256k1zkp_v0_8_1_sha256_initialize_tagged(&sha, aux_tag, sizeof(aux_tag));
    rustsecp256k1zkp_v0_8_1_nonce_function_bip340_sha256_tagged_aux(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);

    rustsecp256k1zkp_v0_8_1_testrand256(msg);
    rustsecp256k1zkp_v0_8_1_testrand256(key);
    rustsecp256k1zkp_v0_8_1_testrand256(pk);
    rustsecp256k1zkp_v0_8_1_testrand256(aux_rand);
    ...
    /* Other algo is fine */
    rustsecp256k1zkp_v0_8_1_testrand_bytes_test(algo, algolen);
    CHECK(nonce_function_bip340(nonce, msg, msglen, key, pk, algo, algolen, NULL) == 1);

    for (i = 0; i < COUNT; i++) {
        unsigned char nonce2[32];
        uint32_t offset = rustsecp256k1zkp_v0_8_1_testrand_int(msglen - 1);
        ...
        offset = rustsecp256k1zkp_v0_8_1_testrand_int(algolen - 1);
    ...
    CHECK(nonce_function_bip340(nonce, msg, msglen, key, pk, algo, algolen, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(nonce_z, nonce, 32) == 0);
}
...
static void test_schnorrsig_api(void) {
    ...
    unsigned char msg[32];
    rustsecp256k1zkp_v0_8_1_keypair keypairs[3];
    rustsecp256k1zkp_v0_8_1_keypair invalid_keypair = {{ 0 }};
    rustsecp256k1zkp_v0_8_1_xonly_pubkey pk[3];
    rustsecp256k1zkp_v0_8_1_xonly_pubkey zero_pk;
    unsigned char sig[64];
    rustsecp256k1zkp_v0_8_1_schnorrsig_extraparams extraparams = SECP256K1_SCHNORRSIG_EXTRAPARAMS_INIT;
    rustsecp256k1zkp_v0_8_1_schnorrsig_extraparams invalid_extraparams = {{ 0 }, NULL, NULL};
    ...
    rustsecp256k1zkp_v0_8_1_testrand256(sk1);
    rustsecp256k1zkp_v0_8_1_testrand256(sk2);
    rustsecp256k1zkp_v0_8_1_testrand256(sk3);
    rustsecp256k1zkp_v0_8_1_testrand256(msg);
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_create(CTX, &keypairs[0], sk1) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_create(CTX, &keypairs[1], sk2) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_create(CTX, &keypairs[2], sk3) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_xonly_pub(CTX, &pk[0], NULL, &keypairs[0]) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_xonly_pub(CTX, &pk[1], NULL, &keypairs[1]) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_xonly_pub(CTX, &pk[2], NULL, &keypairs[2]) == 1);
    memset(&zero_pk, 0, sizeof(zero_pk));

    /** main test body **/
    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, msg, &keypairs[0], NULL) == 1);
    CHECK(ecount == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, NULL, msg, &keypairs[0], NULL) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, NULL, &keypairs[0], NULL) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, msg, NULL, NULL) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, msg, &invalid_keypair, NULL) == 0);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(STATIC_CTX, sig, msg, &keypairs[0], NULL) == 0);
    CHECK(ecount == 5);

    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypairs[0], &extraparams) == 1);
    CHECK(ecount == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, NULL, msg, sizeof(msg), &keypairs[0], &extraparams) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, NULL, sizeof(msg), &keypairs[0], &extraparams) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, NULL, 0, &keypairs[0], &extraparams) == 1);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), NULL, &extraparams) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &invalid_keypair, &extraparams) == 0);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypairs[0], NULL) == 1);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypairs[0], &invalid_extraparams) == 0);
    CHECK(ecount == 5);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(STATIC_CTX, sig, msg, sizeof(msg), &keypairs[0], &extraparams) == 0);
    CHECK(ecount == 6);

    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, msg, &keypairs[0], NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &pk[0]) == 1);
    CHECK(ecount == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, NULL, msg, sizeof(msg), &pk[0]) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, NULL, sizeof(msg), &pk[0]) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, NULL, 0, &pk[0]) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), NULL) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &zero_pk) == 0);
    CHECK(ecount == 4);
...
/* Checks that hash initialized by rustsecp256k1zkp_v0_8_1_schnorrsig_sha256_tagged has the
 * expected state. */
static void test_schnorrsig_sha256_tagged(void) {
    ...
    rustsecp256k1zkp_v0_8_1_sha256_initialize_tagged(&sha, (unsigned char *) tag, sizeof(tag));
    rustsecp256k1zkp_v0_8_1_schnorrsig_sha256_tagged(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);
}
...
static void test_schnorrsig_bip_vectors_check_signing(const unsigned char *sk, const unsigned char *pk_serialized, const unsigned char *aux_rand, const unsigned char *msg, size_t msglen, const unsigned char *expected_sig) {
    ...
    rustsecp256k1zkp_v0_8_1_xonly_pubkey pk, pk_expected;

    rustsecp256k1zkp_v0_8_1_schnorrsig_extraparams extraparams = SECP256K1_SCHNORRSIG_EXTRAPARAMS_INIT;
    extraparams.ndata = (unsigned char*)aux_rand;

    CHECK(rustsecp256k1zkp_v0_8_1_keypair_create(CTX, &keypair, sk));
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, msglen, &keypair, &extraparams));
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(sig, expected_sig, 64) == 0);
    if (msglen == 32) {
        memset(sig, 0, 64);
        CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, msg, &keypair, aux_rand));
        CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(sig, expected_sig, 64) == 0);
    }

    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_parse(CTX, &pk_expected, pk_serialized));
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_xonly_pub(CTX, &pk, NULL, &keypair));
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(&pk, &pk_expected, sizeof(pk)) == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, msglen, &pk));
}
...
static void test_schnorrsig_bip_vectors_check_verify(const unsigned char *pk_serialized, const unsigned char *msg, size_t msglen, const unsigned char *sig, int expected) {
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_parse(CTX, &pk, pk_serialized));
    CHECK(expected == rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, msglen, &pk));
}
...
static void test_schnorrsig_bip_vectors(void) {
    ...
    }
    {
        ...
        rustsecp256k1zkp_v0_8_1_xonly_pubkey pk_parsed;
        /* No need to check the signature of the test vector as parsing the pubkey already fails */
        CHECK(!rustsecp256k1zkp_v0_8_1_xonly_pubkey_parse(CTX, &pk_parsed, pk));
    }
    {
        /* Test vector 6 */
        const unsigned char pk[32] = {
...
static void test_schnorrsig_sign(void) {
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_create(CTX, &keypair, sk));
    CHECK(rustsecp256k1zkp_v0_8_1_keypair_xonly_pub(CTX, &pk, NULL, &keypair));
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, msg, &keypair, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &pk));
    /* Check that deprecated alias gives the same result */
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign(CTX, sig2, msg, &keypair, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(sig, sig2, sizeof(sig)) == 0);

    /* Test different nonce functions */
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypair, &extraparams) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &pk));
    memset(sig, 1, sizeof(sig));
    extraparams.noncefp = nonce_function_failing;
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypair, &extraparams) == 0);
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(sig, zeros64, sizeof(sig)) == 0);
    memset(&sig, 1, sizeof(sig));
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypair, &extraparams) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig2, msg, &keypair, extraparams.ndata) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_memcmp_var(sig, sig2, sizeof(sig)) == 0);
}
...
static void test_schnorrsig_sign_verify(void) {
    ...
    for (i = 0; i < N_SIGS; i++) {
        rustsecp256k1zkp_v0_8_1_testrand256(msg[i]);
        CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig[i], msg[i], &keypair, NULL));
        CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[i], msg[i], sizeof(msg[i]), &pk));
    }

    {
        /* Flip a few bits in the signature and in the message and check that
         * verify and verify_batch (TODO) fail */
        size_t sig_idx = rustsecp256k1zkp_v0_8_1_testrand_int(N_SIGS);
        size_t byte_idx = rustsecp256k1zkp_v0_8_1_testrand_bits(5);
        unsigned char xorbyte = rustsecp256k1zkp_v0_8_1_testrand_int(254)+1;
        sig[sig_idx][byte_idx] ^= xorbyte;
        CHECK(!rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[sig_idx], msg[sig_idx], sizeof(msg[sig_idx]), &pk));
        sig[sig_idx][byte_idx] ^= xorbyte;

        byte_idx = rustsecp256k1zkp_v0_8_1_testrand_bits(5);
    ...
    /* Test overflowing s */
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig[0], msg[0], &keypair, NULL));
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[0], msg[0], sizeof(msg[0]), &pk));
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig[0], msg[0], &keypair, NULL));
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[0], msg[0], sizeof(msg[0]), &pk));
    rustsecp256k1zkp_v0_8_1_scalar_set_b32(&s, &sig[0][32], NULL);
    rustsecp256k1zkp_v0_8_1_scalar_negate(&s, &s);
    rustsecp256k1zkp_v0_8_1_scalar_get_b32(&sig[0][32], &s);
    CHECK(!rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[0], msg[0], sizeof(msg[0]), &pk));

    /* The empty message can be signed & verified */
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig[0], NULL, 0, &keypair, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[0], NULL, 0, &pk) == 1);

    {
        /* Test varying message lengths */
        unsigned char msg_large[32 * 8];
        uint32_t msglen  = rustsecp256k1zkp_v0_8_1_testrand_int(sizeof(msg_large));
        for (i = 0; i < sizeof(msg_large); i += 32) {
            rustsecp256k1zkp_v0_8_1_testrand256(&msg_large[i]);
        }
        CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign_custom(CTX, sig[0], msg_large, msglen, &keypair, NULL) == 1);
        CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[0], msg_large, msglen, &pk) == 1);
        /* Verification for a random wrong message length fails */
        msglen = (msglen + (sizeof(msg_large) - 1)) % sizeof(msg_large);
        CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig[0], msg_large, msglen, &pk) == 0);
    }
}
#undef N_SIGS
...
static void test_schnorrsig_taproot(void) {
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_serialize(CTX, tweak, &internal_pk) == 1);
    ...
    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_serialize(CTX, output_pk_bytes, &output_pk) == 1);

    /* Key spend */
    rustsecp256k1zkp_v0_8_1_testrand256(msg);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_sign32(CTX, sig, msg, &keypair, NULL) == 1);
    /* Verify key spend */
    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_parse(CTX, &output_pk, output_pk_bytes) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &output_pk) == 1);

    /* Script spend */
    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_serialize(CTX, internal_pk_bytes, &internal_pk) == 1);
    /* Verify script spend */
    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_parse(CTX, &internal_pk, internal_pk_bytes) == 1);
    CHECK(rustsecp256k1zkp_v0_8_1_xonly_pubkey_tweak_add_check(CTX, output_pk_bytes, pk_parity, &internal_pk, tweak) == 1);
}
