...
typedef struct {
    int32_t v[9];
} rustsecp256k1zkp_v0_8_1_modinv32_signed30;

typedef struct {
    /* The modulus in signed30 notation, must be odd and in [3, 2^256]. */
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 modulus;

    /* modulus^{-1} mod 2^30 */
    uint32_t modulus_inv30;
} rustsecp256k1zkp_v0_8_1_modinv32_modinfo;
...
/* Same as rustsecp256k1zkp_v0_8_1_modinv32_var, but constant time in x (not in the modulus). */
