...
*/
	...
	.align	2
	.global rustsecp256k1zkp_v0_8_1_fe_mul_inner
	.type	rustsecp256k1zkp_v0_8_1_fe_mul_inner, %function
	.hidden rustsecp256k1zkp_v0_8_1_fe_mul_inner
	@ Arguments:
...
rustsecp256k1zkp_v0_8_1_fe_mul_inner:
	...
	*/
	...
	.size	rustsecp256k1zkp_v0_8_1_fe_mul_inner, .-rustsecp256k1zkp_v0_8_1_fe_mul_inner

	.align	2
	.global rustsecp256k1zkp_v0_8_1_fe_sqr_inner
	.type	rustsecp256k1zkp_v0_8_1_fe_sqr_inner, %function
	.hidden rustsecp256k1zkp_v0_8_1_fe_sqr_inner
	@ Arguments:
	...
	@  sp + #0        saved 'r' pointer
	@  sp + #4 + 4*X  t0,t1,t2,t3,t4,t5,t6,t7,u8,t9
rustsecp256k1zkp_v0_8_1_fe_sqr_inner:
	stmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, r14}
	sub	sp, sp, #48			@ frame=44 + alignment
	str     r0, [sp, #0]			@ save result address, we need it only at the end
	/******************************************
	...
	*/
	...
	add	sp, sp, #48
	ldmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.size	rustsecp256k1zkp_v0_8_1_fe_sqr_inner, .-rustsecp256k1zkp_v0_8_1_fe_sqr_inner
