...
#ifdef VERIFY
static const rustsecp256k1zkp_v0_8_1_modinv32_signed30 SECP256K1_SIGNED30_ONE = {{1}};

/* Compute a*factor and put it in r. All but the top limb in r will be in range [0,2^30). */
static void rustsecp256k1zkp_v0_8_1_modinv32_mul_30(rustsecp256k1zkp_v0_8_1_modinv32_signed30 *r, const rustsecp256k1zkp_v0_8_1_modinv32_signed30 *a, int alen, int32_t factor) {
...
static int rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(const rustsecp256k1zkp_v0_8_1_modinv32_signed30 *a, int alen, const rustsecp256k1zkp_v0_8_1_modinv32_signed30 *b, int32_t factor) {
    int i;
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 am, bm;
    rustsecp256k1zkp_v0_8_1_modinv32_mul_30(&am, a, alen, 1); /* Normalize all but the top limb of a. */
    rustsecp256k1zkp_v0_8_1_modinv32_mul_30(&bm, b, 9, factor);
    for (i = 0; i < 8; ++i) {
 ...
 * [0,2^30). */
static void rustsecp256k1zkp_v0_8_1_modinv32_normalize_30(rustsecp256k1zkp_v0_8_1_modinv32_signed30 *r, int32_t sign, const rustsecp256k1zkp_v0_8_1_modinv32_modinfo *modinfo) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    ...
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, -2) > 0); /* r > -2*modulus */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 1) < 0); /* r < modulus */
#endif
    ...
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 0) >= 0); /* r >= 0 */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 1) < 0); /* r < modulus */
#endif
}
...
typedef struct {
    int32_t u, v, q, r;
} rustsecp256k1zkp_v0_8_1_modinv32_trans2x2;
 ...
 */
static int32_t rustsecp256k1zkp_v0_8_1_modinv32_divsteps_30(int32_t zeta, uint32_t f0, uint32_t g0, rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 *t) {
...
/* rustsecp256k1zkp_v0_8_1_modinv32_inv256[i] = -(2*i+1)^-1 (mod 256) */
static const uint8_t rustsecp256k1zkp_v0_8_1_modinv32_inv256[128] = {
 ...
 */
static int32_t rustsecp256k1zkp_v0_8_1_modinv32_divsteps_30_var(int32_t eta, uint32_t f0, uint32_t g0, rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 *t) {
    /* Transformation matrix; see comments in rustsecp256k1zkp_v0_8_1_modinv32_divsteps_30. */
    uint32_t u = 1, v = 0, q = 0, r = 1;
    ...
    for (;;) {
        ...
        zeros = rustsecp256k1zkp_v0_8_1_ctz32_var(g | (UINT32_MAX << i));
        ...
        w = (g * rustsecp256k1zkp_v0_8_1_modinv32_inv256[(f >> 1) & 127]) & m;
        /* Do so. */
        g += f * w;
        q += u * w;
        r += v * w;
 ...
 * Return: final eta
 */
static int32_t rustsecp256k1zkp_v0_8_1_modinv32_posdivsteps_30_var(int32_t eta, uint32_t f0, uint32_t g0, rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 *t, int *jacp) {
 ...
 */
static void rustsecp256k1zkp_v0_8_1_modinv32_update_de_30(rustsecp256k1zkp_v0_8_1_modinv32_signed30 *d, rustsecp256k1zkp_v0_8_1_modinv32_signed30 *e, const rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 *t, const rustsecp256k1zkp_v0_8_1_modinv32_modinfo* modinfo) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    ...
    int i;
#ifdef VERIFY
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(d, 9, &modinfo->modulus, -2) > 0); /* d > -2*modulus */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(d, 9, &modinfo->modulus, 1) < 0);  /* d <    modulus */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(e, 9, &modinfo->modulus, -2) > 0); /* e > -2*modulus */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(e, 9, &modinfo->modulus, 1) < 0);  /* e <    modulus */
 ...
 */
static void rustsecp256k1zkp_v0_8_1_modinv32_update_fg_30(rustsecp256k1zkp_v0_8_1_modinv32_signed30 *f, rustsecp256k1zkp_v0_8_1_modinv32_signed30 *g, const rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 *t) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
    int32_t fi, gi;
    int64_t cf, cg;
 ...
 */
static void rustsecp256k1zkp_v0_8_1_modinv32_update_fg_30_var(int len, rustsecp256k1zkp_v0_8_1_modinv32_signed30 *f, rustsecp256k1zkp_v0_8_1_modinv32_signed30 *g, const rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 *t) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
    int32_t fi, gi;
    int64_t cf, cg;
...
static void rustsecp256k1zkp_v0_8_1_modinv32(rustsecp256k1zkp_v0_8_1_modinv32_signed30 *x, const rustsecp256k1zkp_v0_8_1_modinv32_modinfo *modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, zeta=-1. */
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 d = {{0}};
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 e = {{1}};
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 f = modinfo->modulus;
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 g = *x;
    int i;
    ...
    for (i = 0; i < 20; ++i) {
        ...
        rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 t;
        zeta = rustsecp256k1zkp_v0_8_1_modinv32_divsteps_30(zeta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        rustsecp256k1zkp_v0_8_1_modinv32_update_de_30(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */
#ifdef VERIFY
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, 1) < 0);  /* g <  modulus */
#endif
        rustsecp256k1zkp_v0_8_1_modinv32_update_fg_30(&f, &g, &t);
#ifdef VERIFY
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, -1) > 0); /* g > -modulus */
...
#ifdef VERIFY
    /* g == 0 */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, 9, &SECP256K1_SIGNED30_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &SECP256K1_SIGNED30_ONE, -1) == 0 ||
                 rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &SECP256K1_SIGNED30_ONE, 1) == 0 ||
                 (rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(x, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&d, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  (rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) == 0 ||
                   rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) == 0)));
#endif

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    rustsecp256k1zkp_v0_8_1_modinv32_normalize_30(&d, f.v[8], modinfo);
    *x = d;
}

/* Compute the inverse of x modulo modinfo->modulus, and replace x with it (variable time). */
static void rustsecp256k1zkp_v0_8_1_modinv32_var(rustsecp256k1zkp_v0_8_1_modinv32_signed30 *x, const rustsecp256k1zkp_v0_8_1_modinv32_modinfo *modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, eta=-1. */
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 d = {{0, 0, 0, 0, 0, 0, 0, 0, 0}};
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 e = {{1, 0, 0, 0, 0, 0, 0, 0, 0}};
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 f = modinfo->modulus;
    rustsecp256k1zkp_v0_8_1_modinv32_signed30 g = *x;
#ifdef VERIFY
    int i = 0;
    ...
    while (1) {
        ...
        rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 t;
        eta = rustsecp256k1zkp_v0_8_1_modinv32_divsteps_30_var(eta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        rustsecp256k1zkp_v0_8_1_modinv32_update_de_30(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */
#ifdef VERIFY
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, 1) < 0);  /* g <  modulus */
#endif
        rustsecp256k1zkp_v0_8_1_modinv32_update_fg_30_var(len, &f, &g, &t);
...
#ifdef VERIFY
    /* g == 0 */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, len, &SECP256K1_SIGNED30_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &SECP256K1_SIGNED30_ONE, -1) == 0 ||
                 rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &SECP256K1_SIGNED30_ONE, 1) == 0 ||
                 (rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(x, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&d, 9, &SECP256K1_SIGNED30_ONE, 0) == 0 &&
                  (rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) == 0 ||
                   rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, -1) == 0)));
#endif

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    rustsecp256k1zkp_v0_8_1_modinv32_normalize_30(&d, f.v[len - 1], modinfo);
    *x = d;
}
...
static int rustsecp256k1zkp_v0_8_1_jacobi32_maybe_var(const rustsecp256k1zkp_v0_8_1_modinv32_signed30 *x, const rustsecp256k1zkp_v0_8_1_modinv32_modinfo *modinfo) {
    ...
    for (count = 0; count < JACOBI32_ITERATIONS; ++count) {
        ...
        rustsecp256k1zkp_v0_8_1_modinv32_trans2x2 t;
        eta = rustsecp256k1zkp_v0_8_1_modinv32_posdivsteps_30_var(eta, f.v[0] | ((uint32_t)f.v[1] << 30), g.v[0] | ((uint32_t)g.v[1] << 30), &t, &jac);
        /* Update f,g using that transition matrix. */
#ifdef VERIFY
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 0) > 0); /* f > 0 */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, 0) > 0); /* g > 0 */
        VERIFY_CHECK(rustsecp256k1zkp_v0_8_1_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, 1) < 0);  /* g < modulus */
#endif
        rustsecp256k1zkp_v0_8_1_modinv32_update_fg_30_var(len, &f, &g, &t);
